...
elaborate()
{
  xelab --relax --debug typical --mt auto -wto dd20e024b4334a62bcd13a63e13ea5a3 -m64 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip --snapshot system xil_defaultlib.system xil_defaultlib.glbl -log elaborate.log
}
